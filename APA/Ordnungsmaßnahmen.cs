...
WHERE vorgang_schuljahr = '" + Global.AktSjAtl + "' AND info_gruppe = 'STRAF' AND schue_sj.pu_id = schueler_info.pu_id ORDER BY Datum", connection);
        ...
        public Maßnahmen(string aktSjAtl, string conAtl, Noten ab)
        {
